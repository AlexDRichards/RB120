...
one called Hello and one called Goodbye. The Hello class should have a hi 
method that takes 
no arguments and prints "Hello". The Goodbye class should have a bye method 
to say "Goodbye". 
...
# This exemplifies the concept that a method called by an object will be able
# to acess methods in another class if the inheritance tree is properly formed
